...
//------------------------------------------------------------
// Constructor
// Initializes values to input with two floats.
//------------------------------------------------------------
...
//------------------------------------------------------------
// Constructor
// Initializes values to input with one float.
//------------------------------------------------------------
...
//------------------------------------------------------------
// operator+
// Adds a complex number and a floating point number or 
// an integer.
// (a + bi) + c = (a + c) + bi
//------------------------------------------------------------
...
//------------------------------------------------------------
// operator-
// Subtracts a complex number and a floating point number or 
// an integer.
// (a + bi) - c = (a - c) + bi
//------------------------------------------------------------
...
{
    Complex c2;
    float first = real * c1.real;
    float middle = (real * c1.imaginary) + (imaginary * c1.real);
    float last = (imaginary * c1.imaginary) * -1;
    c2.real = first + last;
    c2.imaginary = middle;
    return c2;
}    
...
//------------------------------------------------------------
// oeprator*
// Multiplies a complex number and a floating point number
// or an integer.
// (a + bi) * c = ac + bci
//------------------------------------------------------------
...
Complex Complex::operator/  (Complex c1)
{
    ...
    float bottom = (c1.real*c1.real) + ((c1.imaginary*c1.imaginary));
    if (bottom == 0)
    {
...
//------------------------------------------------------------
// operator/
// Divides a complex number by a float number or int.
// (a + bi)/c = a/c + (b/c)i
//------------------------------------------------------------
...
Complex Complex::operator^  (int n)
{
    ...
    {                                   //if n is negative, changes
        ...
        float bottom = (c3.real*c3.real) + ((c3.imaginary*c3.imaginary));
